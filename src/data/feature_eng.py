...
default_selecteds = [
    ...
    # "Episode_Length_minutes-Host_Popularity_percentage-Guest_Popularity_percentage_NaN-HPperc_Int",
    # "Genre-Episode_Sentiment-Length_per_Ads-Length_per_Host",
    # "Length_per_Ads-Length_per_Guest-ELen_Int-HPperc_Int",
    # "Host_Popularity_percentage-Publication_Day-Length_per_Ads-Length_per_Host",
    # "Host_Popularity_percentage-Guest_Popularity_percentage_NaN-ELen_Int-ELen_Dec",
...
def cols_encode(df: pl.DataFrame, combinations_list: list, round_num: int = 16) -> pl.DataFrame:
    batch_size = 20
