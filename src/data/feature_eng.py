...
default_selecteds = [
    ...
    "Episode_Num-Length_per_Ads-Length_per_Host-Expected_Listening_Time_Sentiment",
    ...
    "Number_of_Ads-Episode_Num-HPperc_Int-Expected_Listening_Time_Sentiment",
    ...
    "Episode_Length_minutes-Publication_Day-Number_of_Ads-Is_Positive_Sentiment",
