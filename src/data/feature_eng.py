...
selecteds = [
    ...
    "ELen_Int-Long_Term_Cycle_Sin",
    "Podcast_Name-ELen_Int",
    "Time_cos-Length_per_Host",
    "Length_per_Ads-ELen_Dec",
    "Number_of_Ads-ELen_Dec",
    "Publication_Time-Length_per_Ads",
    "Time_sin-Length_per_Guest",
    "Time_sin-Length_per_Ads",
    ...
    "Length_per_Ads-Long_Term_Cycle_Sin",
    "Episode_Length_minutes-Long_Term_Cycle_Sin",
    ...
    "Length_per_Ads",
    "Length_per_Ads-Long_Term_Cycle_Cos",
    "Publication_Time-ELen_Int",
    "Length_per_Guest-Is_Positive_Sentiment",
    "ELen_Int-Is_Positive_Sentiment",
    "Time_sin2-Length_per_Host",
    "Episode_Length_minutes-Day_cos",
    "Length_per_Ads-Length_per_Host",
    "Genre-ELen_Int",
    "Episode_Length_minutes-Publication_Time",
    "ELen_Dec-Long_Term_Cycle_Sin",
