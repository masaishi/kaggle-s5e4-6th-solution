...
default_selecteds = [
    "Podcast_Name-Episode_Num-Diff_Squared",
    "Episode_Length_minutes-Publication_Day-Diff_Squared",
    "Host_Popularity_percentage-Guest_Popularity_percentage-Expected_Listening_Time_Sentiment",
    ...
    "Episode_Sentiment-Length_per_Guest-Expected_Listening_Time_Sentiment",
    ...
    "Length_per_Ads-ELen_Dec-Expected_Listening_Time_Sentiment",
