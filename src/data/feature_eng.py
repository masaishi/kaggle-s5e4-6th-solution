...
before_fe_selecteds = [
    ...
    "Podcast_Name-Episode_Num-Length_per_Guest-Host_Popularity_percentage_Int",
    ...
    "Podcast_Name-Host_Popularity_percentage-Episode_Num-Episode_Length_minutes_Dec",
    ...
    "Podcast_Name-Host_Popularity_percentage-Episode_Num-Episode_Length_minutes_Int",
    "Podcast_Name-Host_Popularity_percentage-Episode_Length_minutes_Int-Long_Term_Cycle_Sin",
    ...
    "Genre-Host_Popularity_percentage-Episode_Num-Episode_Length_minutes_Int",
    "Time_cos-Length_per_Guest-Host_Popularity_percentage_Int-Is_Positive_Sentiment",
    "Episode_Sentiment-Episode_Num-Length_per_Guest-Episode_Length_minutes_Int",
    "Episode_Length_minutes-Publication_Time-Guest_Popularity_percentage-Host_Popularity_percentage_Int",
    "Host_Popularity_percentage-Publication_Day-Episode_Num-Episode_Length_minutes_Int",
    "Host_Popularity_percentage-Publication_Day-Episode_Length_minutes_Int-Long_Term_Cycle_Sin",
    "Episode_Length_minutes_NaN-Time_sin-Length_per_Guest-Host_Popularity_percentage_Int",
    "Host_Popularity_percentage-Episode_Num-Time_sin2-Episode_Length_minutes_Int",
    "Host_Popularity_percentage-Episode_Sentiment-Episode_Num-Episode_Length_minutes_Int",
    "Host_Popularity_percentage-Episode_Sentiment-Episode_Length_minutes_Int-Long_Term_Cycle_Sin",
    "Host_Popularity_percentage-Episode_Num-Episode_Length_minutes_Int-Is_Positive_Sentiment",
    "Host_Popularity_percentage-Episode_Num-Guest_Popularity_percentage_NaN-Episode_Length_minutes_Int",
    "Host_Popularity_percentage-Guest_Popularity_percentage_NaN-Episode_Length_minutes_Int-Long_Term_Cycle_Cos",
    "Episode_Length_minutes_NaN-Length_per_Guest-Episode_Length_minutes_Int-Host_Popularity_percentage_Int",
    "Host_Popularity_percentage-Episode_Num-Episode_Length_minutes_NaN-Episode_Length_minutes_Int",
    "Host_Popularity_percentage-Episode_Length_minutes_NaN-Episode_Length_minutes_Int-Long_Term_Cycle_Sin",
    "Episode_Length_minutes-Number_of_Ads-Episode_Num-Day_sin",
    "Episode_Length_minutes-Number_of_Ads-Day_cos-Long_Term_Cycle_Cos",
    "Episode_Length_minutes-Day_sin-Length_per_Ads-Host_Popularity_percentage_Int",
    ...
    "Publication_Time-Episode_Num-Length_per_Ads-Episode_Length_minutes_Dec",
    "Episode_Length_minutes-Time_cos2-Length_per_Ads-Long_Term_Cycle_Sin",
    "Episode_Length_minutes-Publication_Time-Length_per_Ads-Host_Popularity_percentage_Int",
    "Episode_Num-Time_cos-Length_per_Ads-Episode_Length_minutes_Dec",
    "Number_of_Ads-Episode_Sentiment-Length_per_Ads-Host_Popularity_percentage_Int",
    "Episode_Length_minutes-Number_of_Ads-Time_cos-Host_Popularity_percentage_Int",
    "Time_sin-Length_per_Ads-Episode_Length_minutes_Int-Host_Popularity_percentage_Int",
    ...
    "Episode_Length_minutes-Number_of_Ads-Host_Popularity_percentage_Int-Is_Positive_Sentiment",
    "Guest_Popularity_percentage_NaN-Length_per_Ads-Episode_Length_minutes_Int-Long_Term_Cycle_Cos",
    "Number_of_Ads-Guest_Popularity_percentage_NaN-Length_per_Ads-Host_Popularity_percentage_Int",
    "Episode_Length_minutes-Time_cos-Host_Popularity_percentage_Int-Is_Positive_Sentiment",
    ...
    "Episode_Length_minutes-Number_of_Ads-Host_Popularity_percentage_Int",
    ...
    "Episode_Length_minutes-Episode_Sentiment-Episode_Length_minutes_NaN-Host_Popularity_percentage_Int",
    "Episode_Length_minutes-Time_cos-Host_Popularity_percentage_Int",
    ...
    "Episode_Length_minutes-Episode_Length_minutes_NaN-Host_Popularity_percentage_Int-Is_Positive_Sentiment",
    "Episode_Length_minutes-Guest_Popularity_percentage_NaN-Episode_Length_minutes_Dec-Host_Popularity_percentage_Int",
    "Publication_Time-Number_of_Ads-Day_sin2-Length_per_Ads",
    "Episode_Length_minutes-Episode_Num-Episode_Length_minutes_NaN-Episode_Length_minutes_Dec",
    ...
    "Genre-Number_of_Ads-Episode_Length_minutes_Int-Host_Popularity_percentage_Int",
    "Episode_Length_minutes_Dec-Is_Positive_Sentiment",
    "Number_of_Ads-Guest_Popularity_percentage_NaN-Episode_Length_minutes_Int",
    "Number_of_Ads-Guest_Popularity_percentage_NaN-Episode_Length_minutes_Int-Is_Positive_Sentiment",
    "Number_of_Ads-Episode_Sentiment-Guest_Popularity_percentage_NaN-Episode_Length_minutes_Int",
    "Publication_Time-Number_of_Ads-Guest_Popularity_percentage_NaN-Episode_Length_minutes_Int",
    "Publication_Day-Number_of_Ads-Guest_Popularity_percentage_NaN-Episode_Length_minutes_Int",
    "Genre-Number_of_Ads-Guest_Popularity_percentage_NaN-Episode_Length_minutes_Int",
    "Time_cos-Length_per_Guest-Host_Popularity_percentage_Dec-Long_Term_Cycle_Sin",
    "Podcast_Name-Publication_Day-Length_per_Guest-Host_Popularity_percentage_Int",
    "Genre-Publication_Day-Length_per_Guest-Host_Popularity_percentage_Int",
    "Host_Popularity_percentage-Publication_Time-Guest_Popularity_percentage-Episode_Length_minutes_Dec",
    "Host_Popularity_percentage-Guest_Popularity_percentage-Time_cos-Long_Term_Cycle_Cos",
    "Day_cos-Length_per_Ads-Host_Popularity_percentage_Dec-Long_Term_Cycle_Cos",
    "Podcast_Name-Episode_Length_minutes-Episode_Length_minutes_NaN-Length_per_Host",
    "Episode_Length_minutes-Genre-Number_of_Ads-Host_Popularity_percentage_Dec",
    ...
    "Episode_Length_minutes-Guest_Popularity_percentage_NaN-Host_Popularity_percentage_Int-Long_Term_Cycle_Sin",
    "Guest_Popularity_percentage-Episode_Sentiment-Time_cos-Length_per_Ads",
    "Genre-Host_Popularity_percentage-Time_cos-Episode_Length_minutes_Int",
    "Host_Popularity_percentage-Publication_Day-Time_cos-Episode_Length_minutes_Int",
    "Host_Popularity_percentage-Publication_Day-Time_sin-Episode_Length_minutes_Int",
    "Guest_Popularity_percentage-Number_of_Ads-Episode_Length_minutes_NaN-Episode_Length_minutes_Int",
    "Guest_Popularity_percentage-Episode_Length_minutes_NaN-Time_sin-Episode_Length_minutes_Int",
    ...
    "Guest_Popularity_percentage_NaN-Episode_Length_minutes_Int-Host_Popularity_percentage_Int-Host_Popularity_percentage_Dec",
    "Podcast_Name-Time_sin-Episode_Length_minutes_Int-Host_Popularity_percentage_Int",
    "Publication_Day-Number_of_Ads-Episode_Length_minutes_Int-Host_Popularity_percentage_Int",
    "Episode_Length_minutes_Int-Is_Positive_Sentiment",
    "Episode_Sentiment-Episode_Length_minutes_NaN-Episode_Length_minutes_Int",
    "Publication_Day-Episode_Length_minutes_NaN-Episode_Length_minutes_Int",
    "Number_of_Ads-Episode_Length_minutes_Dec",
    "Publication_Day-Time_sin-Episode_Length_minutes_Int",
    "Podcast_Name-Publication_Time-Length_per_Guest-Host_Popularity_percentage_Dec",
    "Genre-Publication_Time-Length_per_Guest-Host_Popularity_percentage_Dec",
    "Podcast_Name-Host_Popularity_percentage-Guest_Popularity_percentage-Time_sin2",
    "Guest_Popularity_percentage-Episode_Num-Episode_Length_minutes_Dec-Host_Popularity_percentage_Int",
    ...
    "Podcast_Name-Host_Popularity_percentage-Episode_Length_minutes_Dec-Host_Popularity_percentage_Int",
    "Podcast_Name-Episode_Length_minutes-Episode_Sentiment-Long_Term_Cycle_Sin",
    "Publication_Day-Episode_Sentiment-Length_per_Host-Host_Popularity_percentage_Dec",
    "Publication_Time-Length_per_Ads-Host_Popularity_percentage_Int-Long_Term_Cycle_Cos",
    ...
    "Genre-Episode_Num-Episode_Length_minutes_Int-Host_Popularity_percentage_Dec",
    ...
    "Number_of_Ads-Episode_Num-Episode_Length_minutes_Int-Host_Popularity_percentage_Dec",
    "Number_of_Ads-Episode_Length_minutes_Int-Host_Popularity_percentage_Dec-Long_Term_Cycle_Sin",
    "Episode_Num-Time_sin-Episode_Length_minutes_Int-Host_Popularity_percentage_Dec",
    "Podcast_Name-Time_cos2-Episode_Length_minutes_Int-Host_Popularity_percentage_Dec",
    ...
    "Number_of_Ads-Time_cos-Episode_Length_minutes_Dec",
    "Publication_Time-Number_of_Ads-Episode_Length_minutes_Dec",
    "Publication_Day-Episode_Sentiment-Episode_Length_minutes_Dec",
    "Publication_Day-Number_of_Ads-Episode_Length_minutes_Dec",
    "Publication_Time-Number_of_Ads-Episode_Length_minutes_Dec-Is_Positive_Sentiment",
    "Podcast_Name-Length_per_Guest-Host_Popularity_percentage_Dec-Is_Positive_Sentiment",
    "Publication_Time-Number_of_Ads-Episode_Sentiment-Episode_Length_minutes_Dec",
    "Guest_Popularity_percentage-Episode_Num-Episode_Length_minutes_Dec-Host_Popularity_percentage_Dec",
    "Publication_Day-Number_of_Ads-Time_sin-Episode_Length_minutes_Dec",
    "Podcast_Name-Guest_Popularity_percentage-Episode_Num-Episode_Length_minutes_Dec",
    "Podcast_Name-Guest_Popularity_percentage-Episode_Length_minutes_Dec-Host_Popularity_percentage_Int",
    "Episode_Num-Time_sin-Length_per_Ads-Host_Popularity_percentage_Dec",
    "Episode_Sentiment-Length_per_Ads-Host_Popularity_percentage_Dec-Long_Term_Cycle_Cos",
    "Podcast_Name-Episode_Num-Day_sin-Length_per_Ads",
    "Podcast_Name-Genre-Length_per_Ads-Long_Term_Cycle_Cos",
    "Publication_Time-Length_per_Host-Episode_Length_minutes_Int-Is_Positive_Sentiment",
    "Length_per_Ads-Host_Popularity_percentage_Int-Is_Positive_Sentiment-Long_Term_Cycle_Cos",
    "Host_Popularity_percentage-Episode_Num-Day_sin-Time_sin",
    "Length_per_Ads-Is_Positive_Sentiment",
    "Host_Popularity_percentage-Number_of_Ads-Episode_Sentiment-Episode_Length_minutes_Dec",
    "Host_Popularity_percentage-Number_of_Ads-Episode_Length_minutes_Dec-Is_Positive_Sentiment",
    "Host_Popularity_percentage-Number_of_Ads-Guest_Popularity_percentage_NaN-Episode_Length_minutes_Dec",
    "Number_of_Ads-Episode_Num-Episode_Length_minutes_Dec-Host_Popularity_percentage_Int",
    "Host_Popularity_percentage-Number_of_Ads-Episode_Length_minutes_NaN-Episode_Length_minutes_Dec",
    "Host_Popularity_percentage-Episode_Length_minutes_NaN-Time_cos-Episode_Length_minutes_Dec",
    "Episode_Length_minutes_Dec-Host_Popularity_percentage_Int-Is_Positive_Sentiment-Long_Term_Cycle_Cos",
    "Host_Popularity_percentage-Episode_Length_minutes_NaN-Guest_Popularity_percentage_NaN-Episode_Length_minutes_Dec",
    "Number_of_Ads-Time_cos-Episode_Length_minutes_Dec-Host_Popularity_percentage_Int",
    "Number_of_Ads-Time_sin2-Episode_Length_minutes_Dec-Host_Popularity_percentage_Int",
    "Publication_Time-Number_of_Ads-Episode_Length_minutes_Dec-Long_Term_Cycle_Cos",
]
...
selecteds = [
    ...
    "Host_Popularity_percentage-Episode_Num-Episode_Length_minutes_Int",
    "Episode_Length_minutes-Publication_Day-Length_per_Host",
    "Length_per_Ads-Length_per_Host-Host_Popularity_percentage_Int",
    ...
    "Guest_Popularity_percentage-Episode_Length_minutes_Int-Host_Popularity_percentage_Int",
    "Episode_Length_minutes-Length_per_Ads-Length_per_Host",
    "Length_per_Ads-Length_per_Host-Episode_Length_minutes_Int",
    "Episode_Length_minutes-Number_of_Ads-Length_per_Host",
    "Length_per_Ads-Length_per_Host-Episode_Length_minutes_Dec",
    "Episode_Length_minutes-Guest_Popularity_percentage-Episode_Num",
    "Episode_Length_minutes-Guest_Popularity_percentage-Host_Popularity_percentage_Int",
    "Length_per_Guest-Episode_Length_minutes_Int-Host_Popularity_percentage_Int",
    "Length_per_Guest-Episode_Length_minutes_Dec-Host_Popularity_percentage_Int",
    "Episode_Length_minutes-Publication_Time-Length_per_Host",
    "Podcast_Name-Episode_Length_minutes-Host_Popularity_percentage_Int",
    "Episode_Length_minutes-Genre-Episode_Num",
    "Length_per_Guest-Host_Popularity_percentage_Int",
    "Episode_Length_minutes-Publication_Day-Episode_Num",
    "Episode_Length_minutes-Genre-Host_Popularity_percentage_Int",
    "Guest_Popularity_percentage-Episode_Num-Episode_Length_minutes_Int",
    "Episode_Length_minutes-Host_Popularity_percentage-Episode_Num",
    "Episode_Length_minutes-Publication_Day-Host_Popularity_percentage_Int",
    "Episode_Length_minutes-Episode_Sentiment-Length_per_Host",
    "Guest_Popularity_percentage-Length_per_Host-Host_Popularity_percentage_Int",
    "Episode_Length_minutes-Episode_Num-Length_per_Ads",
    "Episode_Length_minutes-Number_of_Ads-Episode_Num",
    "Episode_Length_minutes-Publication_Day-Host_Popularity_percentage_Dec",
    "Episode_Length_minutes-Publication_Time-Episode_Num",
    "Number_of_Ads-Length_per_Ads-Length_per_Host",
    "Episode_Length_minutes-Length_per_Ads-Host_Popularity_percentage_Int",
    "Episode_Length_minutes-Number_of_Ads-Host_Popularity_percentage_Int",
    "Length_per_Ads-Episode_Length_minutes_Int-Host_Popularity_percentage_Int",
    "Podcast_Name-Episode_Length_minutes-Episode_Num",
    "Episode_Num-Length_per_Ads-Episode_Length_minutes_Dec",
    "Episode_Length_minutes-Guest_Popularity_percentage-Host_Popularity_percentage_Dec",
    "Length_per_Guest-Episode_Length_minutes_Int-Host_Popularity_percentage_Dec",
    "Length_per_Guest-Episode_Length_minutes_Dec-Host_Popularity_percentage_Dec",
    "Episode_Length_minutes-Genre-Host_Popularity_percentage_Dec",
    "Length_per_Ads-Episode_Length_minutes_Dec-Host_Popularity_percentage_Int",
    "Guest_Popularity_percentage-Episode_Num-Length_per_Ads",
    "Guest_Popularity_percentage-Length_per_Guest-Host_Popularity_percentage_Int",
    "Guest_Popularity_percentage-Length_per_Ads-Host_Popularity_percentage_Int",
    "Length_per_Guest-Host_Popularity_percentage_Dec",
    "Episode_Length_minutes-Publication_Time-Host_Popularity_percentage_Int",
    "Episode_Length_minutes-Length_per_Host-Host_Popularity_percentage_Dec",
    "Length_per_Ads-Length_per_Host",
    "Episode_Length_minutes-Length_per_Ads-Length_per_Guest",
    "Length_per_Ads-Length_per_Guest-Episode_Length_minutes_Int",
    "Episode_Length_minutes-Number_of_Ads-Length_per_Guest",
    "Length_per_Ads-Length_per_Guest-Episode_Length_minutes_Dec",
    "Guest_Popularity_percentage-Length_per_Host-Episode_Length_minutes_Int",
    "Episode_Length_minutes-Episode_Sentiment-Episode_Num",
    "Guest_Popularity_percentage-Episode_Length_minutes_Int-Host_Popularity_percentage_Dec",
    ...
    "Host_Popularity_percentage-Guest_Popularity_percentage-Episode_Length_minutes_Int",
    "Episode_Length_minutes-Number_of_Ads-Host_Popularity_percentage_Dec",
    "Episode_Length_minutes-Length_per_Ads-Host_Popularity_percentage_Dec",
    "Length_per_Ads-Episode_Length_minutes_Int-Host_Popularity_percentage_Dec",
    "Length_per_Ads-Episode_Length_minutes_Dec-Host_Popularity_percentage_Dec",
    "Episode_Length_minutes-Episode_Sentiment-Length_per_Guest",
    "Episode_Length_minutes-Length_per_Host-Host_Popularity_percentage_Int",
    "Host_Popularity_percentage-Length_per_Guest-Episode_Length_minutes_Int",
    "Episode_Length_minutes-Publication_Time-Length_per_Guest",
    "Episode_Length_minutes-Publication_Time-Host_Popularity_percentage_Dec",
    "Episode_Length_minutes-Episode_Sentiment-Host_Popularity_percentage_Int",
    "Podcast_Name-Guest_Popularity_percentage-Episode_Length_minutes_Int",
    "Number_of_Ads-Length_per_Ads-Length_per_Guest",
    "Host_Popularity_percentage-Length_per_Host-Episode_Length_minutes_Dec",
    "Host_Popularity_percentage-Episode_Length_minutes_Int-Episode_Length_minutes_Dec",
    "Length_per_Host-Host_Popularity_percentage_Int-Host_Popularity_percentage_Dec",
    "Length_per_Host-Episode_Length_minutes_Dec-Host_Popularity_percentage_Int",
    "Length_per_Host-Episode_Length_minutes_Int-Episode_Length_minutes_Dec",
    "Length_per_Host-Episode_Length_minutes_Int-Host_Popularity_percentage_Dec",
    "Episode_Length_minutes-Host_Popularity_percentage-Length_per_Host",
    "Episode_Length_minutes-Host_Popularity_percentage-Episode_Length_minutes_Int",
    "Episode_Length_minutes-Host_Popularity_percentage-Episode_Length_minutes_Dec",
    "Episode_Length_minutes-Host_Popularity_percentage-Host_Popularity_percentage_Dec",
    "Episode_Length_minutes-Host_Popularity_percentage",
    "Episode_Length_minutes-Host_Popularity_percentage_Int-Host_Popularity_percentage_Dec",
    "Episode_Length_minutes-Host_Popularity_percentage-Host_Popularity_percentage_Int",
    "Episode_Length_minutes-Host_Popularity_percentage-Episode_Length_minutes_NaN",
    "Length_per_Host-Episode_Length_minutes_Int-Host_Popularity_percentage_Int",
    "Length_per_Host-Episode_Length_minutes_Int",
    "Length_per_Host-Episode_Length_minutes_Dec-Host_Popularity_percentage_Dec",
    "Length_per_Host-Host_Popularity_percentage_Int",
    ...
    "Length_per_Host-Episode_Length_minutes_Dec",
    "Length_per_Host-Host_Popularity_percentage_Dec",
...
default_combinations_list = [
    ...
    ["Episode_Length_minutes_Int", "Episode_Num"],
    ["Episode_Length_minutes_Int", "Host_Popularity_percentage"],
    ["Episode_Length_minutes_Int", "Guest_Popularity_percentage"],
    ["Episode_Length_minutes_Dec", "Episode_Num"],
    ["Episode_Length_minutes_Dec", "Episode_Sentiment"],
    ["Episode_Length_minutes_Dec", "Publication_Day"],
    # 3-interaction
    ...
    ["Episode_Length_minutes_Int", "Number_of_Ads", "Episode_Sentiment"],
    ["Episode_Length_minutes_Dec", "Number_of_Ads", "Podcast_Name"],
    # 4-interaction
...
def feature_eng(df: pl.DataFrame, df_train: pl.DataFrame) -> pl.DataFrame:
    ...
    df = df.with_columns(
        ...
        # pl.col("Episode_Length_minutes").floor().alias("Episode_Length_minutes_Int"),
        # (pl.col("Episode_Length_minutes") - pl.col("Episode_Length_minutes").floor()).alias("Episode_Length_minutes_Dec"),
        # pl.col("Host_Popularity_percentage").floor().alias("Host_Popularity_percentage_Int"),
        # (pl.col("Host_Popularity_percentage") - pl.col("Host_Popularity_percentage").floor()).alias("Host_Popularity_percentage_Dec"),
        # Sentiment features
    ...
    for col in ["Episode_Length_minutes", "Host_Popularity_percentage"]:
        ...
        #     transforms.append(
        #         (((pl.col(col) * 10**roun_num).floor()) - ((pl.col(col) * 10 ** (roun_num - 1)).floor() * 10)).alias(f"{col}_round_{roun_num}_dec")
        #     )
...
def add_original_cols(df: pl.DataFrame, df_pltpd: pl.DataFrame) -> pl.DataFrame:
    ...
    combinations_list = []
    # combinations_list += random.sample(default_combinations_list, 20)
