...
before_fe_selecteds = [
    ...
    "Episode_Sentiment-Time_cos2-ELen_Int",
    "Number_of_Ads-Time_cos2-ELen_Int",
    "Number_of_Ads-Day_cos-ELen_Int",
    ...
    "Guest_Popularity_percentage_NaN-ELen_Int-Long_Term_Cycle_Sin",
    "Episode_Length_minutes-Episode_Length_minutes_NaN",
    "Is_Positive_Sentiment-Expected_Listening_Time_Sentiment",
    "ELen_Int-Is_Positive_Sentiment-Expected_Listening_Time_Sentiment",
    "Time_cos-ELen_Int-Long_Term_Cycle_Sin",
    ...
    "Episode_Length_minutes_NaN-ELen_Dec-Expected_Listening_Time_Sentiment",
    "ELen_Dec-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes-Episode_Length_minutes_NaN-Is_Positive_Sentiment",
    "Number_of_Ads-ELen_Int-Long_Term_Cycle_Sin",
    "Episode_Length_minutes_NaN-Length_per_Ads-ELen_Int",
    "Episode_Sentiment-ELen_Int-Expected_Listening_Time_Sentiment",
    "Time_cos-Expected_Listening_Time_Sentiment",
    "Time_cos-ELen_Int-HPperc_Int",
    "Guest_Popularity_percentage_NaN-Is_Positive_Sentiment-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes-Episode_Length_minutes_NaN-Time_cos2",
    ...
    "Guest_Popularity_percentage_NaN-ELen_Dec-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes-Guest_Popularity_percentage_NaN-Is_Positive_Sentiment",
    ...
    "Number_of_Ads-Length_per_Ads-Is_Positive_Sentiment",
    "Length_per_Guest",
    "Guest_Popularity_percentage-Episode_Length_minutes_NaN-Length_per_Ads",
    "Time_sin-Is_Positive_Sentiment-Expected_Listening_Time_Sentiment",
    "Guest_Popularity_percentage-Is_Positive_Sentiment-Expected_Listening_Time_Sentiment",
    "Number_of_Ads-Episode_Num-ELen_Int",
    "Episode_Sentiment-Time_sin-Expected_Listening_Time_Sentiment",
    "Length_per_Guest-Expected_Listening_Time_Sentiment",
    "Length_per_Guest-ELen_Int-Is_Positive_Sentiment",
    "Guest_Popularity_percentage-Day_sin-Length_per_Guest",
    "Guest_Popularity_percentage-Length_per_Ads-Length_per_Guest",
    "Genre-Guest_Popularity_percentage-ELen_Int",
    "Episode_Length_minutes-Guest_Popularity_percentage_NaN-Time_cos2",
    "Episode_Length_minutes-Episode_Sentiment-Guest_Popularity_percentage_NaN",
    "Number_of_Ads-ELen_Int-Expected_Listening_Time_Sentiment",
    "Publication_Time-ELen_Int-Expected_Listening_Time_Sentiment",
    "Number_of_Ads-Guest_Popularity_percentage_NaN-Expected_Listening_Time_Sentiment",
    "Number_of_Ads-Is_Positive_Sentiment-Expected_Listening_Time_Sentiment",
    "Time_cos-ELen_Dec-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes-Time_cos2-Is_Positive_Sentiment",
    "Length_per_Ads-Length_per_Host-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes-Day_sin-Length_per_Host",
    "Guest_Popularity_percentage-Day_sin-ELen_Int",
    "Episode_Length_minutes-Publication_Day-Episode_Num",
    "Length_per_Ads-Length_per_Host-HPperc_Int",
    "Publication_Day-Length_per_Host-Expected_Listening_Time_Sentiment",
    "Publication_Day-Episode_Num-Expected_Listening_Time_Sentiment",
    "Length_per_Ads-Length_per_Host-Sentiment_Multiplier",
    "Episode_Length_minutes-Genre-Length_per_Guest",
    "Episode_Num-Length_per_Ads-Expected_Listening_Time_Sentiment",
    "Genre-Length_per_Guest-Expected_Listening_Time_Sentiment",
    "Length_per_Ads-HPperc_Int-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes-Publication_Day-HPperc_Int",
    "Episode_Length_minutes-Genre-Long_Term_Cycle_Sin",
    "Episode_Length_minutes-Publication_Day-Length_per_Guest",
    "Episode_Length_minutes-Length_per_Ads-Is_Positive_Sentiment",
    "Publication_Time-Length_per_Ads-Length_per_Host",
    "Publication_Day-HPperc_Int-Expected_Listening_Time_Sentiment",
    "Publication_Day-Length_per_Ads-HPperc_Int",
    "Day_sin2-Length_per_Guest-Expected_Listening_Time_Sentiment",
    "Genre-Long_Term_Cycle_Cos-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes-Day_cos-Length_per_Guest",
    "Episode_Length_minutes-Publication_Time-Length_per_Guest",
    "Episode_Length_minutes-Time_sin2-Length_per_Host",
    ...
    "Episode_Length_minutes-Time_cos2-Length_per_Guest",
    "Episode_Length_minutes-Day_cos-HPperc_Dec",
    ...
    "Number_of_Ads-Length_per_Guest-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes-Episode_Num-Length_per_Ads",
    "Episode_Length_minutes-Episode_Num-Day_cos",
    "Episode_Num-Length_per_Ads-ELen_Dec",
    "Publication_Time-HPperc_Dec-Expected_Listening_Time_Sentiment",
    "Length_per_Ads-Length_per_Host",
    "Length_per_Ads-Long_Term_Cycle_Sin-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes-Episode_Sentiment-Length_per_Host",
    "Episode_Length_minutes-Publication_Day-Long_Term_Cycle_Sin",
    "Episode_Length_minutes-Publication_Day-Long_Term_Cycle_Cos",
    "Guest_Popularity_percentage-Length_per_Guest",
    "Episode_Length_minutes-Time_cos2-Length_per_Host",
    "Number_of_Ads-Episode_Num-Expected_Listening_Time_Sentiment",
    ...
    "Episode_Length_minutes-Time_sin2-HPperc_Int",
    "Episode_Length_minutes-Length_per_Ads-HPperc_Int",
    "Length_per_Ads-ELen_Dec-HPperc_Int",
    "Time_sin-Length_per_Ads-ELen_Dec",
    "Time_sin-Length_per_Host-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes-Time_cos2-HPperc_Dec",
    "Episode_Length_minutes-Episode_Num-Time_cos2",
    "Episode_Sentiment-Length_per_Host-Expected_Listening_Time_Sentiment",
    "Time_sin2-HPperc_Int-Expected_Listening_Time_Sentiment",
    "Number_of_Ads-HPperc_Int-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes-Episode_Sentiment-Length_per_Ads",
    "Number_of_Ads-Length_per_Ads-Length_per_Host",
    "Episode_Length_minutes-Length_per_Host-Is_Positive_Sentiment",
    "Length_per_Ads-Is_Positive_Sentiment-Long_Term_Cycle_Cos",
    "Episode_Num-Time_cos2-Expected_Listening_Time_Sentiment",
    "Host_Popularity_percentage-Time_sin-Length_per_Host",
    ...
    "Episode_Sentiment-HPperc_Dec-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes-Time_cos2-HPperc_Int",
    "Publication_Time-Number_of_Ads-Expected_Listening_Time_Sentiment",
    "Episode_Sentiment-Episode_Num-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes-Length_per_Host-HPperc_Int",
    "Guest_Popularity_percentage_NaN-Length_per_Host-Expected_Listening_Time_Sentiment",
    "Episode_Num-Length_per_Ads-ELen_Int",
    "Number_of_Ads-Episode_Num-Length_per_Ads",
    "Episode_Length_minutes-Length_per_Ads-Long_Term_Cycle_Sin",
    "Episode_Length_minutes-Day_cos-Long_Term_Cycle_Sin",
    "Time_cos-HPperc_Int-Expected_Listening_Time_Sentiment",
    "Podcast_Name-Episode_Length_minutes-Length_per_Ads",
    "Podcast_Name-Episode_Length_minutes-Day_cos",
    "Episode_Length_minutes-Episode_Num-Sentiment_Multiplier",
    "Episode_Length_minutes-Publication_Time-Length_per_Ads",
    "Episode_Num-ELen_Dec-Expected_Listening_Time_Sentiment",
    ...
    "Number_of_Ads-Long_Term_Cycle_Sin-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes-Episode_Num-Guest_Popularity_percentage_NaN",
    "Episode_Length_minutes-Time_sin-HPperc_Int",
    "Number_of_Ads-Length_per_Ads-HPperc_Int",
    "Podcast_Name-Day_cos2-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes-HPperc_Int-Sentiment_Multiplier",
    "ELen_Dec-HPperc_Int-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes-Time_cos2-Long_Term_Cycle_Cos",
    "Podcast_Name-Episode_Length_minutes-Time_cos2",
    ...
    "ELen_Int-HPperc_Dec-Expected_Listening_Time_Sentiment",
    "Episode_Num-ELen_Int-Expected_Listening_Time_Sentiment",
    "Genre-Length_per_Ads-ELen_Int",
    "Host_Popularity_percentage-ELen_Int-Is_Positive_Sentiment",
    "Time_cos-Long_Term_Cycle_Sin-Expected_Listening_Time_Sentiment",
    "Time_cos-Long_Term_Cycle_Cos-Expected_Listening_Time_Sentiment",
    "Time_sin-Long_Term_Cycle_Cos-Expected_Listening_Time_Sentiment",
    "HPperc_Int-Is_Positive_Sentiment-Expected_Listening_Time_Sentiment",
    "Podcast_Name-Time_cos2-Expected_Listening_Time_Sentiment",
    ...
    "Episode_Length_minutes-Time_sin-Long_Term_Cycle_Sin",
    "Episode_Length_minutes-Time_sin-Long_Term_Cycle_Cos",
    "ELen_Dec-Long_Term_Cycle_Cos-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes-Publication_Day-Number_of_Ads",
    "Number_of_Ads-Length_per_Ads-Long_Term_Cycle_Sin",
    "Podcast_Name-Episode_Length_minutes-Time_sin",
    "Podcast_Name-Length_per_Ads-ELen_Int",
    "Episode_Length_minutes-HPperc_Int",
    "Guest_Popularity_percentage_NaN-Long_Term_Cycle_Sin-Expected_Listening_Time_Sentiment",
    "Is_Positive_Sentiment-Long_Term_Cycle_Sin-Expected_Listening_Time_Sentiment",
    "Genre-Length_per_Ads-Expected_Listening_Time_Sentiment",
    "Episode_Num-Expected_Listening_Time_Sentiment",
    "Episode_Num-Episode_Length_minutes_NaN-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes_NaN-HPperc_Dec-Expected_Listening_Time_Sentiment",
    "Long_Term_Cycle_Sin-Expected_Listening_Time_Sentiment",
    "Long_Term_Cycle_Cos-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes-ELen_Dec-Long_Term_Cycle_Cos",
    "Episode_Length_minutes-Episode_Length_minutes_NaN-Long_Term_Cycle_Cos",
    "Podcast_Name-Episode_Length_minutes-ELen_Int",
    "HPperc_Int-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes_NaN-Long_Term_Cycle_Sin-Expected_Listening_Time_Sentiment",
    "Episode_Length_minutes_NaN-Long_Term_Cycle_Cos-Expected_Listening_Time_Sentiment",
    "Genre-Day_sin-Expected_Listening_Time_Sentiment",
    "ELen_Int-HPperc_Int-Long_Term_Cycle_Sin",
