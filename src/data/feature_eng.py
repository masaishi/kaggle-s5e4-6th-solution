...
selecteds = [
    ...
    "Number_of_Ads-Time_cos-ELen_Int",
    ...
    "Host_Popularity_percentage-Time_sin-Length_per_Guest-Long_Term_Cycle_Cos",
    ...
    "Publication_Day-Publication_Time-Length_per_Host-Long_Term_Cycle_Sin",
    "Publication_Day-Episode_Sentiment-Length_per_Host-Long_Term_Cycle_Cos",
    "Number_of_Ads-Episode_Num-Time_sin2-Length_per_Host",
    "Episode_Sentiment-Episode_Num-Time_cos-Length_per_Host",
    "Podcast_Name-Host_Popularity_percentage-Episode_Num-ELen_Int",
    "Episode_Num-Guest_Popularity_percentage_NaN-Length_per_Ads-Length_per_Host",
    "Host_Popularity_percentage-Publication_Day-Episode_Num-ELen_Dec",
    ...
    "Time_cos-Length_per_Guest-HPperc_Int-Sentiment_Multiplier",
    "Episode_Length_minutes-Publication_Time-Guest_Popularity_percentage-HPperc_Int",
    "Host_Popularity_percentage-Episode_Num-Day_sin2-ELen_Int",
    "Episode_Length_minutes-Guest_Popularity_percentage-Time_sin-HPperc_Int",
    "Host_Popularity_percentage-Episode_Num-Time_sin2-ELen_Int",
    "Host_Popularity_percentage-Time_cos-ELen_Int-Long_Term_Cycle_Sin",
    ...
    "Episode_Length_minutes-Genre-Number_of_Ads-Episode_Num",
    ...
    "Episode_Length_minutes-Genre-Time_cos-Long_Term_Cycle_Cos",
    "Episode_Length_minutes-Episode_Num-Day_sin-Time_cos2",
    "Episode_Length_minutes-Number_of_Ads-Episode_Num-Day_sin",
    "Episode_Length_minutes-Day_sin2-Time_cos2-Long_Term_Cycle_Cos",
    "Episode_Length_minutes-Number_of_Ads-Day_sin-Long_Term_Cycle_Cos",
    "Episode_Length_minutes-Episode_Sentiment-Episode_Num-Day_sin2",
    "Episode_Length_minutes-Publication_Time-Day_cos-HPperc_Int",
    "Episode_Length_minutes-Publication_Day-Episode_Num-Time_cos",
    ...
    "Episode_Length_minutes-Day_sin-Time_cos-Long_Term_Cycle_Sin",
    "Episode_Length_minutes-Publication_Time-Number_of_Ads-Episode_Num",
    "Episode_Length_minutes-Day_cos-Time_sin-HPperc_Int",
    "Episode_Length_minutes-Publication_Time-Number_of_Ads-Long_Term_Cycle_Cos",
    "Time_cos2-Length_per_Ads-ELen_Int-HPperc_Int",
    "Episode_Length_minutes-Episode_Num-Time_cos-Length_per_Ads",
    "Episode_Sentiment-Length_per_Ads-ELen_Dec-Long_Term_Cycle_Cos",
    "Episode_Sentiment-Length_per_Ads-ELen_Int-HPperc_Int",
    "Episode_Length_minutes-Time_sin-Length_per_Ads-Long_Term_Cycle_Sin",
    "Episode_Length_minutes-Number_of_Ads-Time_cos-HPperc_Int",
    "Episode_Length_minutes-Number_of_Ads-Time_sin-HPperc_Int",
    "Episode_Length_minutes-Episode_Num-Time_cos2-Is_Positive_Sentiment",
    "Episode_Length_minutes-Number_of_Ads-Episode_Num-Is_Positive_Sentiment",
    "Episode_Length_minutes-Episode_Sentiment-Time_sin-HPperc_Int",
    "Episode_Length_minutes-Length_per_Ads-HPperc_Int-Sentiment_Multiplier",
    "Guest_Popularity_percentage_NaN-Length_per_Ads-ELen_Int-Long_Term_Cycle_Cos",
    "Episode_Length_minutes-Guest_Popularity_percentage_NaN-Length_per_Ads-HPperc_Int",
    ...
    "Episode_Length_minutes-Episode_Num-Time_cos",
    ...
    "Guest_Popularity_percentage_NaN-ELen_Int-ELen_Dec-HPperc_Int",
    "Episode_Length_minutes-Publication_Day-Publication_Time-Length_per_Ads",
    "Publication_Time-Day_sin2-Length_per_Ads-ELen_Dec",
    ...
    "Episode_Length_minutes-Publication_Day-Episode_Sentiment-Length_per_Ads",
    "Episode_Length_minutes-Genre-Publication_Time-Sentiment_Multiplier",
    "Episode_Length_minutes-Day_cos-Length_per_Ads-Sentiment_Multiplier",
    "Podcast_Name-Episode_Length_minutes_NaN-ELen_Int-ELen_Dec",
    "Genre-Number_of_Ads-ELen_Int-HPperc_Int",
    "Podcast_Name-Episode_Length_minutes_NaN-ELen_Int-HPperc_Int",
]
