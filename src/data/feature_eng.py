...
default_selecteds = [
    "Number_of_Ads-Episode_Length_minutes_NaN-ELen_Int-HPperc_Int",
    "Episode_Sentiment-Guest_Popularity_percentage_NaN-Length_per_Host-HPperc_Int",
    "Length_per_Guest-HPperc_Dec",
    "Number_of_Ads-Episode_Length_minutes_NaN-Length_per_Host-ELen_Dec",
    "Publication_Day-Episode_Sentiment-Guest_Popularity_percentage_NaN-Length_per_Ads",
    "Episode_Length_minutes_NaN-ELen_Int-HPperc_Dec",
    "Podcast_Name-Episode_Length_minutes-ELen_Dec",
    "Podcast_Name-Publication_Day-Episode_Sentiment-Length_per_Guest",
    "Episode_Length_minutes-Genre-Guest_Popularity_percentage_NaN-Length_per_Ads",
    "Genre-Episode_Sentiment-Length_per_Ads",
    "Publication_Day-Number_of_Ads-Episode_Length_minutes_NaN-Length_per_Ads",
    "Genre-Publication_Time-Number_of_Ads-Length_per_Guest",
    ...
    "Genre-Episode_Num-Episode_Length_minutes_NaN-Length_per_Guest",
    "Episode_Length_minutes-Number_of_Ads-Episode_Length_minutes_NaN-Guest_Popularity_percentage_NaN",
    "Publication_Day-ELen_Int-HPperc_Int",
    "Genre-Length_per_Host-ELen_Int-HPperc_Int",
    "Episode_Sentiment-Length_per_Host-ELen_Int-HPperc_Int",
    "Episode_Length_minutes-Episode_Sentiment-Length_per_Ads-ELen_Dec",
    "Genre-Episode_Length_minutes_NaN-Length_per_Host",
    "Number_of_Ads-ELen_Int-HPperc_Dec",
    "Genre-Episode_Length_minutes_NaN-Length_per_Host-ELen_Int",
    "Publication_Time-Episode_Length_minutes_NaN-Guest_Popularity_percentage_NaN-Length_per_Guest",
    "Episode_Length_minutes-Genre-Guest_Popularity_percentage_NaN-ELen_Dec",
    "Podcast_Name-Episode_Length_minutes_NaN-ELen_Int-HPperc_Int",
    "Genre-Length_per_Guest-HPperc_Int",
    "Genre-Publication_Time-ELen_Int-ELen_Dec",
    "Publication_Time-Episode_Length_minutes_NaN-Length_per_Host-ELen_Dec",
    "Publication_Time-Guest_Popularity_percentage_NaN-ELen_Int-HPperc_Dec",
    "Episode_Length_minutes-Episode_Length_minutes_NaN-Length_per_Ads",
    "Podcast_Name-Publication_Time-Episode_Length_minutes_NaN-Length_per_Guest",
    "Genre-Episode_Sentiment-Length_per_Host",
    "Publication_Day-Number_of_Ads-ELen_Int-ELen_Dec",
    "Genre-Publication_Time-Episode_Length_minutes_NaN-Length_per_Host",
    "Number_of_Ads-Guest_Popularity_percentage_NaN-Length_per_Host-ELen_Int",
    "Podcast_Name-Publication_Day-Episode_Length_minutes_NaN-Length_per_Guest",
    "Number_of_Ads-Length_per_Host-HPperc_Dec",
    "Episode_Length_minutes-Genre-Episode_Sentiment-Episode_Length_minutes_NaN",
    "Episode_Length_minutes-Genre-Number_of_Ads-ELen_Int",
    "Publication_Time-ELen_Int-HPperc_Int",
    "Publication_Day-Length_per_Guest-HPperc_Dec",
    "Podcast_Name-Number_of_Ads-Guest_Popularity_percentage_NaN-Length_per_Host",
    "Publication_Time-Length_per_Guest",
    "Episode_Sentiment-Guest_Popularity_percentage_NaN-Length_per_Guest-HPperc_Int",
    "Episode_Sentiment-Guest_Popularity_percentage_NaN-Length_per_Ads-ELen_Dec",
