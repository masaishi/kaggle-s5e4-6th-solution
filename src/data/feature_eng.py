...
selecteds = [
    ...
    "Number_of_Ads-Episode_Num-Length_per_Host-Is_Positive_Sentiment",
    "Episode_Num-Guest_Popularity_percentage_NaN-Length_per_Ads-Length_per_Host",
    "Episode_Sentiment-Episode_Num-Guest_Popularity_percentage_NaN-Length_per_Host",
    ...
    "Genre-Host_Popularity_percentage-ELen_Int-Long_Term_Cycle_Sin",
    ...
    "Episode_Length_minutes-Guest_Popularity_percentage-Time_cos-HPperc_Int",
    "Length_per_Guest-ELen_Int-Is_Positive_Sentiment-Long_Term_Cycle_Cos",
    "Host_Popularity_percentage-Episode_Num-Time_sin2-ELen_Int",
    "Host_Popularity_percentage-Episode_Sentiment-ELen_Int-Long_Term_Cycle_Cos",
    "Host_Popularity_percentage-Episode_Num-ELen_Int-Is_Positive_Sentiment",
    "Host_Popularity_percentage-ELen_Int-Is_Positive_Sentiment-Long_Term_Cycle_Cos",
    ...
    "Episode_Length_minutes-Time_sin2-Length_per_Ads-Long_Term_Cycle_Cos",
    ...
    "Episode_Length_minutes-Episode_Sentiment-Time_sin2-HPperc_Int",
    ...
    "Episode_Length_minutes-Episode_Num-Time_cos-ELen_Dec",
    "Episode_Length_minutes-Episode_Sentiment-ELen_Dec-Long_Term_Cycle_Cos",
